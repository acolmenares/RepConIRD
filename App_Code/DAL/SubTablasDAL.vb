...
Public Class SubTablasDAL
    ...
    Public Shared Function CargarTiposFamilia(ByVal id_regional As Integer, ByVal id_grupo As Integer, ByVal Fecha_inicial As String, ByVal Fecha_Final As String) As System.Data.DataSet
        Return SqlHelper.ExecuteDataset(strCadenaConexion, "dbo.SubTablasConsultarTiposFamilia", isNothingToDBNull(id_regional), isNothingToDBNull(id_grupo), isNothingToDBNull(Fecha_inicial), isNothingToDBNull(Fecha_Final))
    End Function
    ...
    Public Shared Function CargarPorId_Regional(ByVal Id_Regional As System.Int32) As System.Data.DataSet
        Return SqlHelper.ExecuteDataset(strCadenaConexion, "dbo.SubTablasConsultarPorId_Regional", Id_Regional)
    End Function

    Public Shared Function CargarPorGruposSinAsignar(ByVal Id_Lugar_Entrega As Int32) As System.Data.DataSet
        Return SqlHelper.ExecuteDataset(strCadenaConexion, "dbo.SubtablasConsultarGruposSinAsignar", Id_Lugar_Entrega)
    End Function
End Class
